...
ret, mtx, dist, rvecs, tvecs = camera_calibration(nx, ny, path="camera_cal/calibration*.jpg", show=True)
...
ret, mtx, dist, rvecs, tvecs = camera_calibration(nx, ny, path="camera_cal/calibration*.jpg", show=False)

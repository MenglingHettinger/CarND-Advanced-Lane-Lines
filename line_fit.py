...
def fit_lines_first_img(binary_warped):
    ...
    # store relavant variables in a dictionary
    ret = {}
...
def fit_lines_next_img(binary_warped, left_fit, right_fit, plot=True):
...
def cal_curv(left_fit, right_fit, binary_warped, print_data = True):
    ploty = np.linspace(0, binary_warped.shape[0]-1, binary_warped.shape[0] )
...
def plot_lines(undist, left_fit, right_fit, m_inv, left_curve, right_curve):
    """
